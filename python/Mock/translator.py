    ...
    def transform(self, texts: str) -> List[str]:
        ...
        for text, lang, idx in text_lang_pairs:
            if lang == self.target_lang or lang not in self.allowed_langs:
                ...
                # Tokenize the text
                batch = tokenizer.prepare_translation_batch(src_texts=[
                    "सुबह की ताज़ी हवा मन को शांति और ऊर्जा प्रदान करती है। पेड़-पौधे हमारे जीवन के "
                    "लिए बहुत महत्वपूर्ण होते हैं क्योंकि वे हमें स्वच्छ हवा और छाया देते हैं। हमें हमेशा प्रकृति "
                    "की रक्षा करनी चाहिए और पर्यावरण को स्वच्छ रखना चाहिए। स्वच्छ और हरा-भरा वातावरण "
                    "जीवन को स्वस्थ, सुखमय और सुंदर बनाता है"
                ])
